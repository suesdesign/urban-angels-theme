...
add_action('woocommerce_before_main_content', 'urbanacc_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'urbanac_wrapper_end', 10);

function thc_wrapper_start() {
  echo '<div class="outer-wrapper shadow">
			<div class="container">
				<main id="maincontent" role="main">';
}

function thc_wrapper_end() {
  echo '</main>';
}
